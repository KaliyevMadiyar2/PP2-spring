...
Play = pygame.image.load('lab7/img/play.jpg')
Stop = pygame.image.load('lab7/img/stop.jpg')
Next = pygame.image.load('lab7/img/next.jpg')
Last = pygame.image.load('lab7/img/past.jpg')
...
pygame.mixer.music.load('lab7/sounds/No way.mp3')
pygame.mixer.music.play()

_songs = ['lab7/sounds/No Way.mp3', 'lab7/sounds/Altyn - Tatarka.mp3', 'lab7/sounds/domino - Sped Up.mp3', 'lab7/sounds/Im_the_Infection_.mp3', 'lab7/sounds/Watch Me Work.mp3']
