...
main_clock = pygame.image.load('lab7/img/mainclock.png') 
minute_hand = pygame.image.load(('lab7/img/rightarm.png')) 
second_hand = pygame.image.load(('lab7/img/leftarm.png')) 
